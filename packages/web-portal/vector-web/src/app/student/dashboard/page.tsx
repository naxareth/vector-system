    ...
    <DashboardLayout>
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <button className="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors">
      ...
      <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-6 md:mb-8">
        ...
        <button className="w-full md:w-auto md:ml-auto md:mt-0 mt-3 text-purple-600 hover:text-purple-700 font-medium text-sm flex items-center justify-center md:justify-start gap-1">
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
          ...
          <button className="w-full md:w-auto text-purple-600 hover:text-purple-700 font-medium text-sm flex items-center justify-center md:justify-start gap-1">
            View All
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
