    ...
    <DashboardLayout>
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Credential Verified Resume (CVR)</h1>
            <p className="text-sm md:text-base text-gray-500">Generate blockchain-verified resumes for employers</p>
          </div>
          <button className="w-full md:w-auto bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-lg font-medium flex items-center justify-center gap-2">
