...
export default function SkillDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    const fetchDetail = async () => {
      try {
        // 🛡️ Fetching from our secure API to get the decrypted notes
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-700 px-8 py-10 text-white text-center">
            ...
            <p className="text-purple-100 opacity-90">University Verified Micro-Credential</p>
          </div>
          ...
          <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{new Date(credential.issued_at).toLocaleDateString('en-US', { dateStyle: 'long' })}</p>
              </div>
          ...
          <div className="bg-gray-50 px-8 py-6 border-t border-gray-100 flex justify-between items-center">
             ...
             <Link href="/student/skills" className="px-6 py-2 bg-purple-600 text-white rounded-lg font-bold hover:bg-purple-700 transition-colors shadow-lg">
               Back to Skills
             </Link>
          </div>
        </div>
