...
/* ── Inline color tokens (hex only — avoids lab() issues with html2canvas/print) ── */
const C = {
  white: '#ffffff',
  black: '#111827',
  gray: '#4b5563',
...
/* ======================================================================== */
export function ProfessionalTemplate({ d }: { d: CVRData }) {
...
/*  MODERN TEMPLATE                                                          */
/* ======================================================================== */
export function ModernTemplate({ d }: { d: CVRData }) {
...
/*  SIMPLE TEMPLATE                                                          */
/* ======================================================================== */
export function SimpleTemplate({ d }: { d: CVRData }) {
  return (
...
/* ======================================================================== */
/*  MASTER RESUME DOCUMENT RENDERER                                          */
/* ======================================================================== */
export default function ResumeDocumentRenderer({ data }: { data: CVRData }) {
  if (!data) return null;
  const template = data.template || 'professional';

  if (template === 'modern') {
    return <ModernTemplate d={data} />;
  }
  if (template === 'simple') {
    return <SimpleTemplate d={data} />;
  }
  return <ProfessionalTemplate d={data} />;
}
