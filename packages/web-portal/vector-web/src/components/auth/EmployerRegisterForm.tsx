  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        />
        {errors.companyName && <p className="mt-1.5 text-xs text-red-600 font-semibold">{errors.companyName.message}</p>}
      </div>
      ...
      <div>
        ...
        {errors.password && <p className="mt-1.5 text-xs text-red-600 font-semibold leading-tight">{errors.password.message}</p>}
      ...
      <div>
        ...
        {errors.confirmPassword && <p className="mt-1.5 text-xs text-red-600 font-semibold">{errors.confirmPassword.message}</p>}
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 hover:shadow-sm text-gray-700 font-medium text-sm transition-all"
      >
