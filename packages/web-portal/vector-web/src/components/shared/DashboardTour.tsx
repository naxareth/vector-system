...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description: 'Your blockchain-powered career platform. Let\'s walk you through the key features in under a minute.',
  ...
  },
  {
    ...
    description: 'This is your blockchain identity. Your verified credentials are tied to this wallet address — keep it secure.',
  ...
  },
  {
    ...
    description: 'Track your verified skills count and market relevance score. These update in real-time based on blockchain data and AI analysis.',
  ...
  },
  {
    ...
    description: 'All your university-issued and blockchain-verified skills appear here. Upload a CVR (resume) to get started.',
