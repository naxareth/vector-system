    ...
    <div id="tour-metrics" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 relative">
        <div className="flex items-center justify-between mb-4">
          <div className="p-2 bg-[#06B4C9]/10 rounded-lg">
            <svg className="w-6 h-6 text-[#06B4C9]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
          </div>

          <Tooltip content="Skills permanently verified">
            <div className="text-gray-400 cursor-help hover:text-[#06B4C9] transition-colors">
